...
const Step4: React.FC = () => {
  ...
  const [declarationStatus, setDeclarationStatus] = useState<
    "success" | "needs_edit" | "approved" | "rejected"
  >("success");
...
[تاریخ]`,
  ...
  const renderStatusBanner = () => {
    switch (declarationStatus) {
      case "success":
        return (
          <div className="w-full p-4 mb-6 border border-yellow-400 rounded-lg bg-yellow-50">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-bold text-black">
                      اظهارنامه ها با موفقیت برای دفتر قضایی ارسال شد
                    </p>
                    <p className="text-sm font-bold text-black">
                      نتیجه بررسی تا 48 ساعت آینده برای شما ارسال خواهد شد
                    </p>
                  </div>
                </div>
              </div>
      ...
      case "needs_edit":
        return (
          <div className="w-full p-6 mb-6 bg-white border border-orange-400 rounded-lg">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-right">
                  <h3 className="text-lg font-bold text-black">
                    اظهارنامه نیاز به ویرایش دارند
                  </h3>
                  <p className="text-sm text-gray-600">
                    لطفاً نسبت به اصلاح موارد فوق در اسرع وقت اقدام فرمایید تا
                    فرایند بررسی ادامه یابد.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative flex gap-4">
                <div className="flex-1 p-4 rounded-lg bg-gray-50">
                  <h4 className="mb-2 text-sm font-bold text-black">
                    نقص در اطلاعات مخاطب
                  </h4>
                  <p className="text-sm text-gray-600">
                    نام نماینده و اساس نامه درست نیست
                  </p>
                </div>
                <button className="absolute flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-600 rounded-lg top-2 left-2 hover:bg-blue-700">
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="relative flex gap-4">
                <div className="flex-1 p-4 rounded-lg bg-gray-50">
                  <h4 className="mb-2 text-sm font-bold text-black">
                    نقص در متن اظهارنامه
                  </h4>
                  <p className="text-sm text-gray-600">شماره تماس اشتباه است</p>
                </div>
                <div className="flex flex-col gap-2">
                  <button className="absolute flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-600 rounded-lg hover:bg-blue-700 top-2 left-2">
                    <svg
                      className="w-4 h-4"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <button className="absolute flex items-center gap-2 px-2 py-1 text-xs font-medium text-blue-500 bg-blue-100 rounded-lg bottom-2 left-6">
                    <svg
                      className="w-4 h-4"
                      fill="none"
                      stroke="currentColor"
      ...
      case "approved":
        return (
          <div className="w-full p-4 mb-6 bg-white border border-teal-400 rounded-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                {" "}
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-gray-600">
                    جهت ادامه فرآیند لطفا پرداخت را انجام دهید
                  </p>
                </div>
              </div>
      ...
      case "rejected":
        return (
          <div className="relative w-full p-6 mb-6 bg-white border border-pink-400 rounded-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center justify-center w-8 h-8 border-2 border-pink-400 rounded-full bg-pink-50">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-gray-600">
                    اظهارنامه شما کاملا رد شده به دلایل زیر لطفا مجدد برای ثبت
                    اظهارنامه اقدام نمایید.
                  </p>
                </div>
            ...
            <button
              ...
              className="absolute px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 bottom-3 left-3"
            >
              ثبت مجدد اظهارنامه
            </button>
          </div>
    ...
    <DeclarationLayout currentStep={4}>
      <div className="w-full">
        ...
        <div className="flex w-full gap-6">
          {/* Main Content Area */}
          <div className="flex-1 p-6 rounded-lg bg-stormGray-50">
            <div className="flex flex-col gap-6">
              {/* Subject Section */}
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium text-doveGray-400">
                  موضوع
                </label>
                <div className="h-12 p-3 bg-white rounded-[10px] flex items-center justify-end">
                  <span className="text-sm font-medium text-doveGray-400">
                    {step3Data.subject}
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  <svg
                    className="w-5 h-5 text-doveGray-400"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <label className="text-sm font-medium text-doveGray-400">
                    فایلهای خود را اینجا بارگذاری نمایید
                  </label>
                </div>
                <div className="flex flex-wrap gap-2">
                  {step3Data.attachments && step3Data.attachments.length > 0 ? (
                    step3Data.attachments.map((file, index) => (
                      ...
                      >
                        <span className="text-sm text-doveGray-400">
                          {file.name}
                        </span>
                      </div>
                    ))
